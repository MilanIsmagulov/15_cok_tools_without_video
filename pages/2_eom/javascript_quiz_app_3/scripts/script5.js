const anwserArr = [['проведение замеров с точностью до 0,01 мм'], ['выполнение замеров биения детали, зажатой в патрон токарного станка'], ['проверка прямолинейности поверхности'], ['замер внешних и внутренних размеров'],]; //Ответы в правильном порядке
const text = ["Бесшкальный", "Штангенинструмент", "Головка", "Микрометрический",]
...
textOfQuestionPlace.innerHTML = '<p>' + '<span>' + numberOfQuestion +  '. ' + '</span>'  + 'Установите соответствие между классом механического измерительного инструмента и его назначением.' + '</p>'
