...
const titlePlc = document.querySelector('#txt_title_1')
const firstHeaderPlc = document.querySelector('#first_header')
const isTopicCOK = 'Монтажно-контрольные приспособления <br> и инструмент, методы контроля качества монтажа'
titlePlc.innerHTML = isTopicCOK
firstHeaderPlc.innerHTML = isTopicCOK
...
let mainQuestions = [
    {
        text: 'Укажите, где изображен инструмент под названием «щуп».',
        right: [1],
        type: 1,
        points: 100,
        answers: ['<img width="260px" height="260px" src="./content/2.png" alt="2">', '<img width="260px" height="260px" src="./content/3.png" alt="2">', '<img width="260px" height="260px" src="./content/4.png" alt="2">',],
    },
];
