const anwserArr4 = ['Нутромер', 'Микрометр', 'Угломер', ]
const imgPathArr = ['./content/1_3.jpg', './content/2_3.jpg', './content/3_3.jpg', ] 

const row3 = document.getElementById('row3')
const collumnInner = document.getElementById('drag4-inner')

const blcHeadTxt = 'Монтажно-контрольные приспособления и <br> инструмент, методы контроля качества монтажа'
const blcHeadTxtPlc = document.querySelector('#black_header_text_1')
blcHeadTxtPlc.innerHTML = blcHeadTxt
const TitleTxtPlc = document.querySelector('#title_txt_1')
TitleTxtPlc.innerHTML = blcHeadTxt
...
let questionNumAndTxt = document.querySelector('#question_number_and_text')
questionNumAndTxt.innerHTML = `<span>${numberOfQuestion}. </span> Сопоставьте название инструмента с его изображением.`
